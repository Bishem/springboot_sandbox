...
CREATE TABLE `animal` (
  ...
  PRIMARY KEY (`id`),
  KEY `FK8ht4up5vd7qxcx9okgsdj4538` (`specie_id`),
  CONSTRAINT `FK8ht4up5vd7qxcx9okgsdj4538` FOREIGN KEY (`specie_id`) REFERENCES `specie` (`id`)
...
CREATE TABLE `person` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=utf8 COLLATE=utf8mb3_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `person_animals` (
  ...
  PRIMARY KEY (`persons_id`,`animals_id`),
  ...
  CONSTRAINT `FKq2c74s7eeeoy8tq0sqsjmvbmw` FOREIGN KEY (`persons_id`) REFERENCES `person` (`id`)
...
INSERT INTO `specie` VALUES (1,'Chat','Felis silvestris catus'),(2,'Chien','Canis lupus familiaris'),(3,'Lapin','Oryctolagus cuniculus');
